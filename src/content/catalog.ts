...
export const caseStudySummaries: CaseStudySummary[] = [
  {
    ...
    description: "I built a customer finance portal that let the business withdraw public access to an ageing platform without retiring the system it still depended on.",
    featured: true,
  ...
  },
  {
    ...
    description: "I untangled a 12,000-line SQL calculation, separated the business rules and made individual lease balances available on demand.",
    featured: true,
  ...
  },
  {
    ...
    description: "I rebuilt the public website in Qwik and implemented a server-side lead flow that made enquiries and campaign attribution easier to follow.",
    featured: true,
  ...
  },
  {
    ...
    description: "I pre-migrated eligible customer accounts, then upgraded each password from a legacy SHA-1 hash to Argon2 when its owner returned.",
    featured: true,
  ...
  },
  {
    ...
    description: "I added fresh identity checks to sensitive customer actions and enforced them at the API, not just in the React interface.",
    featured: false,
  ...
  },
  {
    ...
    description: "I handled initial containment, owned network and workstation restoration, and worked with an external specialist on the subsequent investigation.",
    featured: false,
